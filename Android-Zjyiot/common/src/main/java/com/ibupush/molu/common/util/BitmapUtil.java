        ...
        if (bitmap != null && !bitmap.isRecycled()) {
            try {
                ...
                if (byteArrayOutputStream.toByteArray() == null) {
                    LogUtil.e("bitmap2Bytes byteArrayOutputStream toByteArray=null");
                }
                return byteArrayOutputStream.toByteArray();
            } catch (Exception e) {
                LogUtil.e("bitmap2Bytes exception="+e.toString());
            } finally {
            ...
            LogUtil.e("bitmap2Bytes bitmap == null or bitmap.isRecycled()");
            return null;
        }
    }
        ...
        if (datas != null && datas.length > byteCount) {
            ...
            if (outputStream != null) {
                ...
                if (outputStreamByte.length > byteCount) {
                    LogUtil.e("compressBitmap cannot compress to " + byteCount + ", after compress size=" + outputStreamByte.length);
                }
